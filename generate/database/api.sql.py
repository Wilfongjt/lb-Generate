...
class API_Configuration(ShallowDictionary):
    ...
    def load(self,_definitions={}):
        ...
        self.makeFuncPattern()

    def makeFuncPattern(self):
...
class API(dict):
    ...
    def load(self,_definitions={}):
        ...
        # convert parameters to funcPattern by POST, GET, PUT, DELETE
        ...
        for key in _definitions:
            ...
            if 'schema' in cpy_definition:
                ...
                for method in methods:
                    ...
                    parameters = ['{}'.format(cpy_definition['parameters'][method][param]) for param in cpy_definition['parameters'][method]]
